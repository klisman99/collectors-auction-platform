...
function DraftWorkspace() {
  const blank = (): Omit<Draft, 'id' | 'images'> => ({ category: 'CARDS', title: '', description: '', condition: 'EXCELLENT', conditionNotes: '', ownershipDeclared: false });
