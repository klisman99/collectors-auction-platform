...
function DraftWorkspace() {
  const blank = (): Omit<Draft, 'id' | 'images'> => ({
    category: 'CARDS',
    title: '',
    description: '',
    condition: 'EXCELLENT',
  ...
  async function save(event: FormEvent) {
    ...
    try {
      ...
      setEditing({ ...draft, images: undefined } as Omit<Draft, 'id' | 'images'>);
