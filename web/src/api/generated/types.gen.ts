...
/**
 * A safe, append-only fact visible in a history timeline.
 */
export type AuditHistoryEventResponse = {
    id?: string;
    action?: string;
    targetType?: string;
    targetId?: string;
...
/**
 * A deterministic page of role-filtered audit history.
 */
export type AuditHistoryPageResponse = {
    content?: Array<AuditHistoryEventResponse>;
    page?: number;
    size?: number;
 ...
 */
export type AdministrativeAuditHistoryEventResponse = {
    id?: string;
    actorType?: string;
    actorId?: string;
    action?: string;
...
/**
 * A complete administrator-visible page of audit history.
 */
export type AdministrativeAuditHistoryPageResponse = {
    content?: Array<AdministrativeAuditHistoryEventResponse>;
    page?: number;
    size?: number;
    totalElements?: number;
    totalPages?: number;
...
export type ListOperationalAuditHistoryData = {
    body?: never;
    path?: never;
    query?: {
        page?: number;
    ...
    url: '/api/v1/operations/audit-records';
};

export type ListOperationalAuditHistoryResponses = {
    /**
     * OK
     */
    200: AuditHistoryPageResponse;
};

export type ListOperationalAuditHistoryResponse = ListOperationalAuditHistoryResponses[keyof ListOperationalAuditHistoryResponses];
...
export type ListMyHistoryData = {
    ...
    url: '/api/v1/history/mine';
};

export type ListMyHistoryResponses = {
    /**
     * OK
     */
    200: AuditHistoryPageResponse;
...
export type ListMyHistoryResponse = ListMyHistoryResponses[keyof ListMyHistoryResponses];
...
export type ListPublicAuctionTimelineData = {
    body?: never;
    path: {
        auctionId: string;
    };
    ...
    url: '/api/v1/auctions/{auctionId}/timeline';
};

export type ListPublicAuctionTimelineResponses = {
    /**
     * OK
     */
    200: AuditHistoryPageResponse;
...
export type ListPublicAuctionTimelineResponse = ListPublicAuctionTimelineResponses[keyof ListPublicAuctionTimelineResponses];
...
export type ListAdministratorAuditHistoryData = {
    body?: never;
    path?: never;
    query?: {
        page?: number;
...
export type ListAdministratorAuditHistoryResponses = {
    /**
     * OK
     */
    200: AdministrativeAuditHistoryPageResponse;
};

export type ListAdministratorAuditHistoryResponse = ListAdministratorAuditHistoryResponses[keyof ListAdministratorAuditHistoryResponses];
