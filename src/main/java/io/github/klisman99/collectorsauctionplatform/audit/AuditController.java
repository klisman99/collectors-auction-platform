...
class AuditController {
  ...
  @GetMapping
  @Operation(
      operationId = "listAdministrativeAuditRecords",
      summary = "List the administrator audit summary")
  List<AuditResponse> list() {
    return auditQueryService.listAll().stream().map(AuditResponse::from).toList();
  }
