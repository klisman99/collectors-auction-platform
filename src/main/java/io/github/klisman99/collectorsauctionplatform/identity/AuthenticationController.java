...
class AuthenticationController {
  ...
  @Operation(
      operationId = "registerRegularAccount",
      summary = "Register a regular account and request email verification")
  RegistrationResponse register(@Valid @RequestBody RegistrationRequest request) {
    RegistrationService.RegistrationResult registration =
        registrationService.register(request.email(), request.publicHandle(), request.password());
  ...
  @Operation(
      operationId = "verifyRegularAccountEmail",
      summary = "Verify a regular account with a single-use email token")
  VerificationResponse verifyEmail(@Valid @RequestBody VerifyEmailRequest request) {
    RegistrationService.VerificationResult verification =
  ...
  @Operation(
      operationId = "signInRegularAccount",
      summary = "Sign in with a revocable server-side session")
  ...
  @Operation(
      ...
      summary = "Read the authenticated account state")
  ...
  @Operation(
      ...
      summary = "Request a single-use password recovery email")
  ...
  @Operation(
      ...
      summary = "Consume a password recovery token and change the password")
  ...
  @Operation(
      ...
      summary = "Revoke every server-side session for the account")
  ...
  @Schema(
      name = "Registration",
      description = "The accepted public state of a newly registered regular account.")
  record RegistrationResponse(String publicHandle, String status) {}

  @Schema(
      name = "EmailVerification",
      description = "The result of consuming an email-verification token.")
  ...
  @Schema(
      name = "PasswordRecoveryRequestAccepted",
      description = "A generic response that does not reveal whether an account exists.")
  record PasswordRecoveryResponse(String status) {}

  @Schema(
      name = "PasswordReset",
      description = "The result of consuming a password recovery token.")
