...
class OperationalAccount {
  ...
  static OperationalAccount invite(
    ...
    return new OperationalAccount(
        id, normalizedEmail, role, passwordHash, invitedAt, invitedBy, OperationalStatus.INVITED);
  }

  static OperationalAccount initialAdministrator(
      UUID id, String normalizedEmail, String passwordHash, Instant createdAt) {
    return new OperationalAccount(
        id,
        normalizedEmail,
