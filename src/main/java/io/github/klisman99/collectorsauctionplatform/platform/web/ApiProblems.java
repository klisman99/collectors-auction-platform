...
class ApiProblems {
  ...
  ResponseEntity<ProblemDetail> invalidRequest(
    ...
    List<FieldViolation> fieldErrors =
        exception.getBindingResult().getFieldErrors().stream().map(this::toFieldViolation).toList();
  ...
  ResponseEntity<ProblemDetail> invalidRequestParameter(
  ...
  private ResponseEntity<ProblemDetail> response(
    ...
    return ResponseEntity.status(status)
        .body(problem(status, code, null, detail, List.of(), request));
  }
